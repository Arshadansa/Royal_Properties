...
const Rent = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const res = await API.get("/api/v1/getPropsonRent");
  ...
  return (
    <div className="text-left pl-6 pt-14">
      <h1 className="text-black-500 text-2xl font-bold">Properties for Rent</h1>
      <h4 className="text-slate-400">With Special offer</h4>
      {projects.length === 0 ? (
        <>
          {" "}
